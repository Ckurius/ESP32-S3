...
Optionale Quellcode‑Ordner (falls du die Firmware/Skripte mitveröffentlichst)
...
Hinweis: MIT passt gut zum Code (HTML/CSS/JS). Für die inhaltlichen Mess‑Ergebnisse und Texte käme alternativ CC BY 4.0 infrage. Wähle, was zu deinem Vorhaben passt — ich kann dir die passende LICENSE‑Datei erstellen.
👤 Autor
